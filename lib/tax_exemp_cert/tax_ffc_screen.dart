...
class TaxFfcScreen extends StatefulWidget {
  static const routeName = '/taxFfcScrn';

  @override
  State<TaxFfcScreen> createState() => _TaxFfcScreenState();
}

class _TaxFfcScreenState extends State<TaxFfcScreen> {
  var _isInit = true;
                      ...
                      if (snapshot.data == null) {
                        ...
                        return Padding(
                          ...
                          child: Column(
                            children: <Widget>[
                              Text(
                                'FFC Tax Exemption Certificates',
                                style: TextStyle(
                                  fontSize: 18,
