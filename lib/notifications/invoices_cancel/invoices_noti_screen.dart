...
class InvoicesCanNotificationScreen extends StatefulWidget {
  static const routeName = '/invCanNoti';
  @override
  _InvoicesCanNotificationScreenState createState() =>
      _InvoicesCanNotificationScreenState();
}

class _InvoicesCanNotificationScreenState
    extends State<InvoicesCanNotificationScreen> {
  var _isInit = true;
                        ...
                        if (snapshot.data == null) {
                          ...
                          if (invoiceItems.isEmpty) {
                            return Container(
                              ...
                              child: Center(
                                child: Text(
                                  'منسوخ شدہ انوائس کے بارے میں فی الحال کوئی اطلاع نہیں ہے۔',
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                    fontSize: 26,
                                    fontFamily: 'Urdu',
