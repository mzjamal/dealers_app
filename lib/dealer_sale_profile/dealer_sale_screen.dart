...
import './dealer_sale_item.dart';
import '../home/home_tabs_screen.dart';
import '../globals.dart';

class DealerSaleScreen extends StatefulWidget {
  static const routeName = '/dealerSaleScreen';
  @override
  _DealerSaleScreenState createState() => _DealerSaleScreenState();
}

class _DealerSaleScreenState extends State<DealerSaleScreen> {
  var _isInit = true;
  String dCode;
  ...
  Future<List<DealerSaleItem>> _getJsonData() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        DealerSaleItem dealerSaleItem = DealerSaleItem(
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                alignment: Alignment.center,
                                child: Text(
                                  'نوٹ : مقدار میٹرک ٹن میں ہے اور سیلز مہینے / سال کے آج کے دن تک ہے',
