...
class _OrdersLast30DaysScreenState extends State<OrdersLast30DaysScreen> {
  ...
  final _urlReport =
      'https://ffcportal.ffc.com.pk:8881/opendocumentnew/orders30days.jsp';

  final String url =
      'https://ffcportal.ffc.com.pk:8853/sap/opu/odata/sap/ZSDA30ORDERS_SRV/ZSDA30Orders?sap-client=200&\$format=json';
